    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        <AdaptiveText style={{
            ...
            marginBottom: 40,
            alignSelf: 'center'
        }}>Settings</AdaptiveText>
        <AdaptiveView style={styles.container}>
            {settingsPage('Account', 'account-circle', () => {router.push('/(tabs)/profile/settings/account-settings-screen')})}
            {settingsPage('Location', 'privacy-tip', () => {router.push('/(tabs)/profile/settings/location-settings-screen')})}
        </AdaptiveView>
      </ScrollView>
    </SafeAreaView>
  );
